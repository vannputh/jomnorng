...
import { Loader2, Copy, RefreshCw, Heart } from "lucide-react";
...
export default function CaptionsDisplay({
    captions,
    selectedCaption,
    setSelectedCaption,
    selectedVibeOption,
            ...
            <CardContent className="space-y-4">
                ...
                {selectedCaption && (
                    <div className="space-y-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                        ...
                        />
                        <Button
                            onClick={() => onCopyToClipboard(selectedCaption)}
