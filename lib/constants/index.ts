import { Coffee, Zap, Smile, Sparkles, Heart, Star } from "lucide-react";
import type {
    VibeOption,
    BusinessType,
    TargetAudience,
...
export const VIBE_OPTIONS: VibeOption[] = [
    {
        value: "casual",
        label: "ធម្មតា និងមិត្តភាព",
        labelEn: "Casual & Friendly",
        icon: Coffee,
    },
    {
        value: "professional",
    ...
    },
    {
        value: "trendy",
        label: "ទាន់សម័យ",
        labelEn: "Trendy & Modern",
        icon: Heart,
    },
    {
        value: "luxury",
        label: "ឆើតឆាយ",
        labelEn: "Luxury & Elegant",
        icon: Star,
    },
];
...
export const TARGET_AUDIENCES: TargetAudience[] = [
    ...
    {
        value: "adults",
        label: "មនុស្សពេញវ័យ (២៦-៤០)",
        labelEn: "Adults (26-40)",
    },
    {
        value: "middle-aged",
